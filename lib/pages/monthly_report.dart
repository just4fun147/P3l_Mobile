...
class MonthylyPage extends StatefulWidget {
  @override
  _HomeState createState() => _HomeState();
}

class _HomeState extends State<MonthylyPage> {
  String name = '';
  int? selectedYear;
  List<String> years = [];
  ...
  Future<void> _launchUrl(selectedYear) async {
    var _url = Uri.tryParse(
        'http://192.168.33.5:3000/report/p/newCust/${selectedYear}');
